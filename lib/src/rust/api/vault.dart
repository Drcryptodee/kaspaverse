...
// These functions are ignored because they are not marked as `pub`: `active_until`, `atomic_write`, `blob_path`, `broadcast_status`, `build_wallet_signer`, `chain_store_dir`, `change_cursor_path`, `change_cursor`, `current_status`, `derive_wallet_addresses`, `derive_wallet_branches`, `endpoint_cache_path`, `export_seed_for_keystore`, `from_bytes`, `given_on_disk`, `given_receive_indices`, `given_receive_path`, `is_unlocked`, `load_vault_from_seed_bytes`, `lock_epoch`, `lock_grace_path`, `lock_grace_secs`, `lockout_delay_secs`, `lockout_path`, `mark_receive_given`, `node_config_dir`, `now_unix`, `persisted_count`, `prefs_dir`, `read_blob`, `read_capped`, `read_lockout`, `reveal_ceremony_words`, `scan_high_water`, `scan_window_path`, `set_change_cursor`, `set_lock_grace_secs`, `set_scan_high_water`, `set_vault_if_current`, `status_tx`, `to_bytes`, `transport_decryptor`, `transport_store_dir`, `vault_dir`, `wallet_address_at`, `wallet_store_path`, `write_lockout`
