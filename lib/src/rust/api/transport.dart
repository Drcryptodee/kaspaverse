...
// These functions are ignored because they are not marked as `pub`: `apply_intent`, `clamp_display`, `fill_walks`, `frame_dto`, `friendly_prepare_error`, `handle_inbound_comm`, `handle_inbound_handshake`, `handle_inbound`, `hub`, `invite_expired`, `key_window`, `kind_of_intent`, `now_unix_ms`, `open_with_fallback`, `ping_notice_inputs`, `ping`, `prepare_comm_plaintext`, `prepare_transport_send`, `resolve_gap_age`, `row_source`, `run_fill`, `split_frame`, `stash_intent`, `tail_start`, `take_intent`, `thread_pings`, `thread_row`, `to_core_branch`, `to_dto`, `to_key_branch`, `tx_status_dto`, `warn_store`, `watch_acceptance`, `watched`, `widen_key_window`, `x_only_of`
